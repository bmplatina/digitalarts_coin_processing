...
void draw() {
    ...
    checkIncreasing(1);
    textWithStroke(isIncreasing + Integer.toString(coinPriceChanges[1]), 7, 494.5, height/2+150, 36, #FFFFFF, #FF0000);
    textWithStroke("디아테크", 7, width/2, 547.0, 36, #000000, #FFFFFF);
    checkIncreasing(2);
    textWithStroke(isIncreasing + Integer.toString(coinPriceChanges[2]), 7, width/2, height/2+150, 36, #FFFFFF, #FF0000);
    textWithStroke("디아엔터", 7, 1098.5, 547.0, 36, #000000, #FFFFFF);
    checkIncreasing(3);
    textWithStroke(isIncreasing + Integer.toString(coinPriceChanges[3]), 7, 1098.5, height/2+150, 36, #FFFFFF, #FF0000);
